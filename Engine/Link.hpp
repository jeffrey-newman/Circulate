...
//             std::string _status, bool _isSupplyLink, bool _isDemandLink);
        ...
        virtual int
        getInt(const std::string & param) = 0;
        virtual double
        getDouble(const std::string & param) =0;
        virtual std::string
        getString(const std::string & param) =0;
        virtual bool
        getBool(const std::string & param) =0;
        
        virtual void
        setInt(const std::string & param, int value) =0;
        virtual void
        setDouble(const std::string & param, double & value) =0;
        virtual void
        setString(const std::string & param, std::string & value) =0;
        virtual void
        setBool(const std::string & param, bool value) =0;
